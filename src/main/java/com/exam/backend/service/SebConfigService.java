...
//             + "  <string>" + hashedQuit + "</string>\n"
			...
			+ "  <array>\n"
			+ "    <dict><key>active</key><true/><key>executable</key><string>Teams.exe</string><key>originalName</key><string></string><key>os</key><integer>1</integer><key>autostart</key><false/><key>allowBackground</key><true/></dict>\n"
			+ "    <dict><key>active</key><true/><key>executable</key><string>ms-teams.exe</string><key>originalName</key><string></string><key>os</key><integer>1</integer><key>autostart</key><false/><key>allowBackground</key><true/></dict>\n"
			+ "    <dict><key>active</key><true/><key>executable</key><string>msedgewebview2.exe</string><key>originalName</key><string></string><key>os</key><integer>1</integer><key>autostart</key><false/><key>allowBackground</key><true/></dict>\n"
			+ "  </array>\n"
            ...
            + "    <dict><key>active</key><false/><key>executable</key><string>msedgewebview2.exe</string><key>originalName</key><string></string><key>os</key><integer>1</integer></dict>\n"
